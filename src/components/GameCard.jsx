...
export default function GameCard({ gameData }) {
    return (
       <div className=" flex flex-col flex-nowrap justify-center gap-1 rounded-lg border-[3px] border-yellow-600 shadow-lg  hover:bg-sky-800 mt-4">
         <div className="h-12 flex items-center justify-center">
            <h1 className="text-2xl font-medium text-yellow-300">{gameData.name}</h1>
          </div>
         <div>
        ...
        <div className="flex flex-col text-left items-center">
         ...
         <p className="text-yellow-300 text-left">Released: {format(gameData.released, 'PPP')} </p>
